...
def main(url="https://www.allrecipes.com/recipe/219963/",make_vegan=False,make_non_vegan=False,make_healthy=False,make_unhealthy=False,change_style=False,style="middle eastern",DIY_to_easy=False,change_cooking_method=True,method=("heat","fry")):
