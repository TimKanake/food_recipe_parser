...
def main(url="https://www.allrecipes.com/recipe/44989/",make_vegan=False,make_non_vegan=False,make_healthy=False,make_unhealthy=False,change_style=True,style="Mexican",DIY_to_easy=True,change_cooking_method=False,method=("heat","fry")):
